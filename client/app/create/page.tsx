...
const cardSchema = z.object({
    name: z.string().max(20).min(1, "Um nome é obrigatório"),
    email: z.string().email("Insira um email válido").min(1, "O email é obrigatório."),
    title: z.string().max(20).min(1, "Um título é obrigatório"),
    message: z.string().max(1500).min(1, "Uma mensagem é obrigatória"),
