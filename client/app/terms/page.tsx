        ...
        <div>
          ...
          <div className="flex flex-col justify-between gap-5 mt-10">
            ...
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              ...
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Ao acessar e utilizar a nossa plataforma, você concorda em cumprir e ficar vinculado aos seguintes Termos de Uso. Caso não concorde com qualquer parte destes termos, você não deve utilizar a plataforma.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">2. Descrição do Serviço</h2>
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Nossa plataforma permite que casais criem uma página personalizada preenchendo um formulário com seu nome, data de início do relacionamento, uma mensagem personalizada e até 5 fotos. Após o preenchimento, o casal é direcionado para o checkout e, ao concluir o pagamento, recebe um link com um QR Code via email.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">3. Cadastro e Segurança</h2>
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Para utilizar o serviço, você deve fornecer um endereço de email válido. Não compartilharemos seu email com terceiros.</p>
            </div>
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">4. Privacidade</h2>
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Respeitamos a sua privacidade. Não utilizamos seus dados para qualquer tipo de processamento ou venda de dados para terceiros. O email cadastrado é utilizado apenas para o envio do link da página personalizada.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">5. Conteúdo do Usuário</h2>
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Você é responsável pelo conteúdo que insere na plataforma, incluindo fotos, mensagens e informações do relacionamento. Não nos responsabilizamos por qualquer conteúdo impróprio ou ilegal carregado pelos usuários.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">6. Pagamentos e Reembolsos</h2>
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Todos os pagamentos são processados através do PagBank. Após a conclusão do pagamento, o casal receberá um link para a página personalizada via email. Não oferecemos reembolsos, exceto em casos excepcionais a nosso exclusivo critério.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">7. Modificações no Serviço</h2>
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Nós nos comprometemos a sempre manter o serviço ativo e disponível. No entanto, em circunstâncias excepcionais que fujam ao nosso controle, como questões legais, técnicas ou financeiras, reservamo-nos o direito de modificar ou descontinuar o serviço.
            ...
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              ...
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Em nenhuma circunstância seremos responsáveis por qualquer dano indireto, incidental, especial ou consequente decorrente de ou relacionado ao uso ou incapacidade de uso da plataforma.</p>
            </div>
            ...
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              ...
              <p className="px-2 pb-1 justify-between font-normal text-sm text-left">Se você tiver alguma dúvida sobre estes Termos de Uso, entre em contato conosco pelo email: lovelinkapp00@gmail.com.</p>
            </div>
          </div>
      </div>
    </main>
