        ...
        <div>
          ...
          <div className="flex flex-col justify-between gap-5 mt-10">
            ...
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              ...
              <p className="px-2 justify-between font-normal text-sm text-left">Sua privacidade é importante para nós. Esta Política de Privacidade descreve como coletamos, usamos, armazenamos e protegemos suas informações pessoais quando você utiliza nossa plataforma.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">2. Informações que Coletamos</h2>
              <p className="px-2 justify-between font-normal text-sm text-left">Coletamos as seguintes informações quando você utiliza nossa plataforma:Informações de Cadastro: Nome, data de início do relacionamento, mensagem personalizada, fotos do casal e endereço de email cadastrado. Informações de Pagamento: Endereço de email cadastrado no PagBank para processamento do pagamento e envio do link da página personalizada.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">3. Como Usamos Suas Informações</h2>
              <p className="px-2 justify-between font-normal text-sm text-left">Utilizamos suas informações para: Processar o pagamento e enviar o link da página personalizada via email. Personalizar e criar a página do casal com as informações fornecidas. Melhorar nossos serviços e suporte ao cliente.</p>
            </div>
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">4. Compartilhamento de Informações</h2>
              <p className="px-2 justify-between font-normal text-sm text-left">Não compartilhamos suas informações pessoais com terceiros, exceto conforme necessário para processar pagamentos (PagBank) e conforme exigido por lei.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">5. Segurança</h2>
              <p className="px-2 justify-between font-normal text-sm text-left">Implementamos medidas de segurança para proteger suas informações pessoais contra acesso, uso ou divulgação não autorizados. No entanto, nenhuma transmissão de dados pela internet é completamente segura, e não podemos garantir a segurança absoluta.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">6. Retenção de Dados</h2>
              <p className="px-2 justify-between font-normal text-sm text-left">Reteremos suas informações pessoais apenas pelo tempo necessário para cumprir as finalidades para as quais foram coletadas ou conforme exigido por lei.</p>
            </div>

            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              <h2 className="text-lg px-2 py-1 font-bold text-rose-400">7. Seus Direitos</h2>
              <p className="px-2 justify-between font-normal text-sm text-left">Você tem o direito de acessar ou excluir suas informações pessoais. Para exercer esses direitos, entre em contato conosco pelo email: lovelinkapp00@gmail.com</p>
            </div>     
            ...
            <div className="w-full p-3 bg-[#0d0d2b] border-1 rounded-2xl border-[#1d1d3a]">
              ...
              <p className="px-2 justify-between font-normal text-sm text-left">Se você tiver alguma dúvida sobre esta Política de Privacidade, entre em contato conosco pelo email: lovelinkapp00@gmail.com</p>
            </div>
          </div>
      </div>
    </main>
